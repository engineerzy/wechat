  ...
  <div id="add-community-school">
    ...
    <div class="content">
      ...
      <div class="content-type" v-if="typeArr.length>0">
        <p class="title">类型</p>
        <div class="type-list">
          <span class="btn-group" :class="item.active?'active':''" v-for="(item,index) in typeArr" :key="index" @click="infoType(index)">{{item.name}}</span>
        </div>
      </div>
      <div class="upload-img">
        ...
        <div class="img-box">
          <div class="img-list">
            <div class="img" v-for="(item,index) in imgArr" :key="index" @touchstart="delImg(item.src)" @touchend="cleartime">
      ...
      <div class="upload-video">
        ...
        <div class="video-box">
          <div class="video-list" v-if="videoArr.length>0" @click="showPlay">
            <div class="video" v-for="(item,index) in videoArr" :key="index" @touchstart="delVedio" @touchend="cleartime">
  ...
  export default {
    ...
    methods:{
      ...
      submitInfo(){
        ...
        addCommunityInfo({content:this.message,imgUrl:this.upKey,clsId:this.classing,type:this.typing,videoUrl:this.vedioKey})
          .then(res=>{
