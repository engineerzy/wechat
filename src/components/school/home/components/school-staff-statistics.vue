<template>
  <div class="content">
    <div class="list flower-content">
      <IconTitle icon-class="icon-diet" :content="title"></IconTitle>
      <div class="flower-main">
        <div class="reward-flower">
          <span class="flower-text">教师{{extra.teacherCount}}人</span>
        </div>
        <div class="punishment-flower">
          <span class="flower-text">校长{{extra.adminCount}}人</span>
        </div>
      </div>
    </div>
  </div>
