...
import LastMonthFee from './components/last-month-fee'
import StudentStatistics from './components/student-statistics'
import SchoolStaffStatistics from './components/school-staff-statistics'
import StudentPayableThisWeek from './components/student-payable-this-week'
...
export default {
  ...
  components: {
    ...
    LastMonthFee,
    StudentStatistics,
    SchoolStaffStatistics,
    StudentPayableThisWeek,
    StudentBirthday,
    Attendance,
    Homework,
    SafflowerComment,
  ...
  computed: {
    data() {
      ...
      let data = this.$store.getters['schoolHome/getSchoolHomeIndexData']
...
.school {
  ...
  background: url('../../../../src/assets/img/parents/index/bg.png') no-repeat 0 0;
